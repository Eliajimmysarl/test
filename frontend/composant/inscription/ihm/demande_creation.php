<form method="POST" action="index.php?demande=creation" role="form"  id="theForm" >
				...
				<div class="form-steps">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="password" class="form-control" name="password" required="" id="mdp" placeholder="mot de passe" autocomplete="off">
							</div>
